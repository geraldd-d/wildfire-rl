...
# functions for finding fire and agent spawnpoints
...
# Class to generate elevation map (Perlin Noise)
# credits to https://gist.github.com/eevee/26f547457522755cb1fb8739d0ea89a1
...
# dictionary to map the layers of the environment.
# to access grid's type, can use env[x, y, layers["type"]]
layers = {
    "type": 0,
    "threshold": 1,
    "heat": 2,
...
# dictionary of grid types and corresponding values
type_map = {
    "dirt": 0,
    "grass": 1,
    "fire": 2,
